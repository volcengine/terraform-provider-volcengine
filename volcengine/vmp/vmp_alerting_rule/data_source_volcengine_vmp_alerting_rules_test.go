...
const testAccVolcengineVmpAlertingRulesDatasourceConfig = `
...
func TestAccVolcengineVmpAlertingRulesDatasource_Basic(t *testing.T) {
	resourceName := "data.volcengine_vmp_alerting_rules.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVolcengineVmpAlertingRulesDatasourceConfig,
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(acc.ResourceId, "alerting_rules.#", "1"),
				),
			},
		},
	})
