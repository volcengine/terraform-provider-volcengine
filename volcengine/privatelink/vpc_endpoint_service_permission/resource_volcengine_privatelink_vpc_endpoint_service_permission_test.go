...
const testAccVolcenginePrivatelinkVpcEndpointServicePermissionCreateConfig = `
...
func TestAccVolcenginePrivatelinkVpcEndpointServicePermissionResource_Basic(t *testing.T) {
	resourceName := "volcengine_privatelink_vpc_endpoint_service_permission.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVolcenginePrivatelinkVpcEndpointServicePermissionCreateConfig,
