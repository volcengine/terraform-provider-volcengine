package vpc_endpoint_service_resource_test
...
const testAccVolcenginePrivatelinkVpcEndpointServiceResourceCreateConfig = `
...
func TestAccVolcenginePrivatelinkVpcEndpointServiceResourceResource_Basic(t *testing.T) {
	resourceName := "volcengine_privatelink_vpc_endpoint_service_resource.foo"

	acc := &volcengine.AccTestResource{
		ResourceId: resourceName,
		SvcInitFunc: func(client *ve.SdkClient) ve.ResourceService {
			return vpc_endpoint_service_resource.NewService(client)
		},
	}
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config:             testAccVolcenginePrivatelinkVpcEndpointServiceResourceCreateConfig,
				ExpectNonEmptyPlan: true,
				Check: resource.ComposeTestCheckFunc(
					volcengine.AccTestCheckResourceExists(acc),
					resource.TestCheckResourceAttrSet(acc.ResourceId, "resource_id"),
