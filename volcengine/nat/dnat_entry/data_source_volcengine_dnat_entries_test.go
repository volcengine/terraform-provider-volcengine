...
func TestAccVolcengineDnatEntriesDatasource_Basic(t *testing.T) {
	resourceName := "data.volcengine_dnat_entries.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVolcengineDnatEntriesDatasourceConfig,
