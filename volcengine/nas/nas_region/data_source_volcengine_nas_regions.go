...
func DataSourceVolcengineNasRegions() *schema.Resource {
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						...
						"status": {
							Type:        schema.TypeString,
							Computed:    true,
							Description: "The status info of region.",
						},
					},
				},
			},
...
func dataSourceVolcengineRegionsRead(d *schema.ResourceData, meta interface{}) error {
	...
	return ve.DefaultDispatcher().Data(regionService, d, DataSourceVolcengineNasRegions())
}
