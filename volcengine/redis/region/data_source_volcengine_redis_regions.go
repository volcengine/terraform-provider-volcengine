...
func DataSourceVolcengineRedisRegions() *schema.Resource {
...
func dataSourceVolcengineRegionsRead(d *schema.ResourceData, meta interface{}) error {
	redisRegionService := NewRegionService(meta.(*ve.SdkClient))
	return ve.DefaultDispatcher().Data(redisRegionService, d, DataSourceVolcengineRedisRegions())
}
