...
const testAccVolcengineVolumeAttachDeleteWithInstanceConfig = `
data "volcengine_zones" "foo"{
}
...
func TestAccVolcengineVolumeAttachResource_DeleteWithInstance(t *testing.T) {
	resourceName := "volcengine_volume_attach.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config:      testAccVolcengineVolumeAttachDeleteWithInstanceConfig,
