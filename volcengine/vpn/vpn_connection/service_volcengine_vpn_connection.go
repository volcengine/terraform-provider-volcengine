...
type VolcengineVpnConnectionService struct {
	Client *ve.SdkClient
}

func NewVpnConnectionService(c *ve.SdkClient) *VolcengineVpnConnectionService {
	return &VolcengineVpnConnectionService{
		Client: c,
	}
}

func (s *VolcengineVpnConnectionService) GetClient() *ve.SdkClient {
	return s.Client
}

func (s *VolcengineVpnConnectionService) ReadResources(m map[string]interface{}) (data []interface{}, err error) {
	var (
...
func (s *VolcengineVpnConnectionService) ReadResource(resourceData *schema.ResourceData, id string) (data map[string]interface{}, err error) {
	var (
		results []interface{}
		ok      bool
	)
...
func (s *VolcengineVpnConnectionService) RefreshResourceState(resourceData *schema.ResourceData, target []string, timeout time.Duration, id string) *resource.StateChangeConf {
...
func (VolcengineVpnConnectionService) WithResourceResponseHandlers(v map[string]interface{}) []ve.ResourceResponseHandler {
...
func (s *VolcengineVpnConnectionService) CreateResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
...
func (s *VolcengineVpnConnectionService) ModifyResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
	callbacks := make([]ve.Callback, 0)
...
func (s *VolcengineVpnConnectionService) RemoveResource(resourceData *schema.ResourceData, r *schema.Resource) []ve.Callback {
...
func (s *VolcengineVpnConnectionService) DatasourceResources(*schema.ResourceData, *schema.Resource) ve.DataSourceInfo {
...
func (s *VolcengineVpnConnectionService) ReadResourceId(id string) string {
	return id
}
