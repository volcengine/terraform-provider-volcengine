...
const testAccVolcengineVpnConnectionCreateConfig = `
...
const testAccVolcengineVpnConnectionUpdateConfig = `
data "volcengine_zones" "foo"{
}
...
func TestAccVolcengineVpnConnectionResource_Basic(t *testing.T) {
	resourceName := "volcengine_vpn_connection.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVolcengineVpnConnectionCreateConfig,
...
func TestAccVolcengineVpnConnectionResource_Update(t *testing.T) {
	resourceName := "volcengine_vpn_connection.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccVolcengineVpnConnectionUpdateConfig,
				Check: resource.ComposeTestCheckFunc(
					volcengine.AccTestCheckResourceExists(acc),
