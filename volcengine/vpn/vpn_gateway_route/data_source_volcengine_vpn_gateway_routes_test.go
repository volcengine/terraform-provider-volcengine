...
const testAccVolcengineVpnGatewayRoutesDatasourceConfig = `
...
func TestAccVolcengineVpnGatewayRoutesDatasource_Basic(t *testing.T) {
	resourceName := "data.volcengine_vpn_gateway_routes.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVolcengineVpnGatewayRoutesDatasourceConfig,
