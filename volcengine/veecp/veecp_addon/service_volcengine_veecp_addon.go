...
type VolcengineVeecpAddonService struct {
	Client     *ve.SdkClient
	Dispatcher *ve.Dispatcher
}

func NewVeecpAddonService(c *ve.SdkClient) *VolcengineVeecpAddonService {
	return &VolcengineVeecpAddonService{
		Client:     c,
		Dispatcher: &ve.Dispatcher{},
	}
}

func (s *VolcengineVeecpAddonService) GetClient() *ve.SdkClient {
	return s.Client
}

func (s *VolcengineVeecpAddonService) ReadResources(m map[string]interface{}) (data []interface{}, err error) {
	var (
...
func (s *VolcengineVeecpAddonService) ReadResource(resourceData *schema.ResourceData, resourceId string) (data map[string]interface{}, err error) {
	var (
		results []interface{}
		ok      bool
	)
...
func (s *VolcengineVeecpAddonService) RefreshResourceState(resourceData *schema.ResourceData, target []string, timeout time.Duration, id string) *resource.StateChangeConf {
	...
	return &resource.StateChangeConf{
		...
		Refresh: func() (result interface{}, state string, err error) {
			...
			for _, v := range failStates {
				if v == status.(string) {
					failStateTimes++
					if failStateTimes > 10 {
						return nil, "", fmt.Errorf("veecp_addon status error, status: %s", status.(string))
					}
					return d, "", nil
				}
			}
...
func (s *VolcengineVeecpAddonService) CreateResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
...
func (VolcengineVeecpAddonService) WithResourceResponseHandlers(d map[string]interface{}) []ve.ResourceResponseHandler {
...
func (s *VolcengineVeecpAddonService) ModifyResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
...
func (s *VolcengineVeecpAddonService) RemoveResource(resourceData *schema.ResourceData, r *schema.Resource) []ve.Callback {
	callback := ve.Callback{
		Call: ve.SdkCall{
			Action:      "DeleteAddon",
			ContentType: ve.ContentTypeJson,
...
func (s *VolcengineVeecpAddonService) DatasourceResources(*schema.ResourceData, *schema.Resource) ve.DataSourceInfo {
...
func (s *VolcengineVeecpAddonService) ReadResourceId(id string) string {
	return id
}
...
func (s *VolcengineVeecpAddonService) updateConfig(name interface{}, data map[string]interface{}, client *ve.SdkClient, call ve.SdkCall) (*map[string]interface{}, error) {
	var (
