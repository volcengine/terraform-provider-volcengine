...
func DataSourceVolcengineVeecpSupportAddons() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVolcengineVeecpSupportAddonsRead,
...
func dataSourceVolcengineVeecpSupportAddonsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewVeecpSupportAddonService(meta.(*ve.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceVolcengineVeecpSupportAddons())
}
