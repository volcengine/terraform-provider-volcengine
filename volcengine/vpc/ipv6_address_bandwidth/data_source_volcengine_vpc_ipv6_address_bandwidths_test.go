...
const testAccIpv6AddressBandwidthConfig = `
	...
	data "volcengine_vpc_ipv6_address_bandwidths" "foo" {
	  associated_instance_id = "${volcengine_ecs_instance.foo.id}"
	}
`

func TestAccVolcengineIpv6AddressBandwidthDataSource_Basic(t *testing.T) {
	resourceName := "data.volcengine_vpc_ipv6_address_bandwidths.foo"
