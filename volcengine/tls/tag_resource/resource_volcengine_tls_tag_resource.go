...
func ResourceVolcengineTlsTagResource() *schema.Resource {
...
func resourceVolcengineTlsTagCreate(d *schema.ResourceData, meta interface{}) error {
	...
	return ve.DefaultDispatcher().Create(service, d, ResourceVolcengineTlsTagResource())
}

func resourceVolcengineTlsTagRead(d *schema.ResourceData, meta interface{}) error {
	service := NewTlsTagService(meta.(*ve.SdkClient))
	return ve.DefaultDispatcher().Read(service, d, ResourceVolcengineTlsTagResource())
}

func resourceVolcengineTlsTagDelete(d *schema.ResourceData, meta interface{}) error {
	service := NewTlsTagService(meta.(*ve.SdkClient))
	return ve.DefaultDispatcher().Delete(service, d, ResourceVolcengineTlsTagResource())
}
