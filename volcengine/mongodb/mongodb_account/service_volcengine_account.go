...
func NewService(c *ve.SdkClient) *VolcengineMongoDBAccountService {
...
func (s *VolcengineMongoDBAccountService) WithResourceResponseHandlers(zone map[string]interface{}) []ve.ResourceResponseHandler {
...
func (s *VolcengineMongoDBAccountService) ModifyResource(resourceData *schema.ResourceData, resource *schema.Resource) (callbacks []ve.Callback) {
	return callbacks
}
