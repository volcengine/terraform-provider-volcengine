...
const testAccVolcengineRdsMysqlAccountsDatasourceConfig = `
...
func TestAccVolcengineRdsMysqlAccountsDatasource_Basic(t *testing.T) {
	resourceName := "data.volcengine_rds_mysql_accounts.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVolcengineRdsMysqlAccountsDatasourceConfig,
