...
const testAccVolcengineRdsMysqlAllowlistsDatasourceConfig = `
...
func TestAccVolcengineRdsMysqlAllowlistsDatasource_Basic(t *testing.T) {
	resourceName := "data.volcengine_rds_mysql_allowlists.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVolcengineRdsMysqlAllowlistsDatasourceConfig,
