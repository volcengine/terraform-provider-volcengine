...
const testAccVolcengineRdsMysqlAllowlistAssociateCreateConfig = `
...
func TestAccVolcengineRdsMysqlAllowlistAssociateResource_Basic(t *testing.T) {
	resourceName := "volcengine_rds_mysql_allowlist_associate.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVolcengineRdsMysqlAllowlistAssociateCreateConfig,
