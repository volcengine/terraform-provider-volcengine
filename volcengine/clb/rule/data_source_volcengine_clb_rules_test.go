...
const testAccVolcengineClbRulesDatasourceConfig = `
...
func TestAccVolcengineClbRulesDatasource_Basic(t *testing.T) {
	resourceName := "data.volcengine_clb_rules.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVolcengineClbRulesDatasourceConfig,
