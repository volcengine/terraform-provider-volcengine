...
const testAccVolcengineVkeNodesDatasourceConfig = `
...
func TestAccVolcengineVkeNodesDatasource_Basic(t *testing.T) {
	resourceName := "data.volcengine_vke_nodes.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVolcengineVkeNodesDatasourceConfig,
