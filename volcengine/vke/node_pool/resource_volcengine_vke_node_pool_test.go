...
const testAccVolcengineVkeNodePoolSystemVolumeAndDataVolumeConfig = `
...
// 修改系统盘（修改）和数据盘（修改&减少）
func TestAccVolcengineVkeNodePoolResource_VolumeUpdate(t *testing.T) {
	resourceName := "volcengine_vke_node_pool.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccVolcengineVkeNodePoolSystemVolumeAndDataVolumeConfig,
				Check: resource.ComposeTestCheckFunc(
					volcengine.AccTestCheckResourceExists(acc),
					resource.TestCheckResourceAttr(acc.ResourceId, "name", "acc-test-node-pool"),
					resource.TestCheckResourceAttr(acc.ResourceId, "auto_scaling.#", "1"),
...
const testAccVolcengineVkeNodePoolDeleteDataVolumeConfig = `
...
// 清空数据盘
func TestAccVolcengineVkeNodePoolResource_ClearVolumeUpdate(t *testing.T) {
	resourceName := "volcengine_vke_node_pool.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccVolcengineVkeNodePoolDeleteDataVolumeConfig,
				Check: resource.ComposeTestCheckFunc(
					volcengine.AccTestCheckResourceExists(acc),
					resource.TestCheckResourceAttr(acc.ResourceId, "name", "acc-test-node-pool"),
					resource.TestCheckResourceAttr(acc.ResourceId, "auto_scaling.#", "1"),
