...
const testAccVolcengineVkeKubeconfigsDatasourceConfig = `
...
func TestAccVolcengineVkeKubeconfigsDatasource_Basic(t *testing.T) {
	resourceName := "data.volcengine_vke_kubeconfigs.foo"

	acc := &volcengine.AccTestResource{
		ResourceId: resourceName,
		Svc:        &kubeconfig.VolcengineVkeKubeconfigService{},
	}
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVolcengineVkeKubeconfigsDatasourceConfig,
