...
const testAccVolcengineRdsPostgresqlInstancesDatasourceConfig = `
...
func TestAccVolcengineRdsPostgresqlInstancesDatasource_Basic(t *testing.T) {
	resourceName := "data.volcengine_rds_postgresql_instances.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVolcengineRdsPostgresqlInstancesDatasourceConfig,
