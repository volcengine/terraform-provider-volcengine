...
```
$ terraform import volcengine_scalinggroup_server_group.default scg-mizl7m1kqccg5smt1bdpijuj
```

*/

func ResourceVolcengineScalinggroupServerGroup() *schema.Resource {
	resource := &schema.Resource{
		Create: resourceVolcengineScalinggroupServerGroupCreate,
		Read:   resourceVolcengineScalinggroupServerGroupRead,
...
func resourceVolcengineScalinggroupServerGroupCreate(d *schema.ResourceData, meta interface{}) (err error) {
	serverGroupService := NewScalinggroupServerGroupService(meta.(*ve.SdkClient))
	err = serverGroupService.Dispatcher.Create(serverGroupService, d, ResourceVolcengineScalinggroupServerGroup())
	if err != nil {
		return fmt.Errorf("error on creating ScalinggroupServerGroup %q, %s", d.Id(), err)
	}
	return resourceVolcengineScalinggroupServerGroupRead(d, meta)
}

func resourceVolcengineScalinggroupServerGroupRead(d *schema.ResourceData, meta interface{}) (err error) {
	serverGroupService := NewScalinggroupServerGroupService(meta.(*ve.SdkClient))
	err = serverGroupService.Dispatcher.Read(serverGroupService, d, ResourceVolcengineScalinggroupServerGroup())
	if err != nil {
...
func resourceVetackScalinggroupServerGroupUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	serverGroupService := NewScalinggroupServerGroupService(meta.(*ve.SdkClient))
	err = serverGroupService.Dispatcher.Update(serverGroupService, d, ResourceVolcengineScalinggroupServerGroup())
	if err != nil {
...
func resourceVetackScalinggroupServerGroupDelete(d *schema.ResourceData, meta interface{}) (err error) {
	serverGroupService := NewScalinggroupServerGroupService(meta.(*ve.SdkClient))
	err = serverGroupService.Dispatcher.Delete(serverGroupService, d, ResourceVolcengineScalinggroupServerGroup())
	if err != nil {
