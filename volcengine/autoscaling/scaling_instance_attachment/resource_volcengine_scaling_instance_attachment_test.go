...
const testAccVolcengineScalingInstanceAttachmentCreateConfig = `
...
func TestAccVolcengineScalingInstanceAttachmentResource_Basic(t *testing.T) {
	resourceName := "volcengine_scaling_instance_attachment.foo"

	acc := &volcengine.AccTestResource{
		ResourceId: resourceName,
		Svc:        &scaling_instance_attachment.VolcengineScalingInstanceAttachmentService{},
	}
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVolcengineScalingInstanceAttachmentCreateConfig,
