...
const testAccVolcengineScalingConfigurationsDatasourceConfig = `
...
func TestAccVolcengineScalingConfigurationsDatasource_Basic(t *testing.T) {
	resourceName := "data.volcengine_scaling_configurations.foo"
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVolcengineScalingConfigurationsDatasourceConfig,
