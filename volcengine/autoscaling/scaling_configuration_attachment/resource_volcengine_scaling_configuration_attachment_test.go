...
const testAccVolcengineScalingConfigurationAttachmentCreateConfig = `
...
const testAccVolcengineScalingConfigurationAttachmentUpdateConfig = `
data "volcengine_zones" "foo"{
}
...
func TestAccVolcengineScalingConfigurationAttachmentResource_Basic(t *testing.T) {
	resourceName := "volcengine_scaling_configuration_attachment.foo"

	acc := &volcengine.AccTestResource{
		ResourceId: resourceName,
		Svc:        &scaling_configuration_attachment.VolcengineScalingConfigurationAttachmentService{},
	}
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVolcengineScalingConfigurationAttachmentCreateConfig,
			...
			{
				Config: testAccVolcengineScalingConfigurationAttachmentUpdateConfig,
				Check: resource.ComposeTestCheckFunc(
					volcengine.AccTestCheckResourceExists(acc),
				),
			},
