...
func TestAccVolcengineScalingInstancesDatasource_Basic(t *testing.T) {
	resourceName := "data.volcengine_scaling_instances.foo"

	acc := &volcengine.AccTestResource{
		ResourceId: resourceName,
		Svc:        &scaling_instance.VolcengineScalingInstanceService{},
	}
	...
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccVolcengineScalingInstancesDatasourceConfig,
