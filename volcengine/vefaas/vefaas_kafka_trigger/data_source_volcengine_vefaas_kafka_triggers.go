...
func DataSourceVolcengineVefaasKafkaTriggers() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVolcengineVefaasKafkaTriggersRead,
...
func dataSourceVolcengineVefaasKafkaTriggersRead(d *schema.ResourceData, meta interface{}) error {
	service := NewVefaasKafkaTriggerService(meta.(*ve.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceVolcengineVefaasKafkaTriggers())
}
