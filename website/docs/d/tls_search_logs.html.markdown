...
subcategory: "TLS"
layout: "volcengine"
page_title: "Volcengine: volcengine_tls_search_logs"
sidebar_current: "docs-volcengine-datasource-tls_search_logs"
description: |-
  Use this data source to query detailed information of tls search logs
---
# volcengine_tls_search_logs
Use this data source to query detailed information of tls search logs
## Example Usage
```hcl
data "volcengine_tls_search_logs" "default" {
