...
layout: "volcengine"
page_title: "Volcengine: volcengine_vpc_gateway_endpoints"
sidebar_current: "docs-volcengine-datasource-vpc_gateway_endpoints"
description: |-
  Use this data source to query detailed information of vpc gateway endpoints
---
# volcengine_vpc_gateway_endpoints
Use this data source to query detailed information of vpc gateway endpoints
## Example Usage
```hcl
