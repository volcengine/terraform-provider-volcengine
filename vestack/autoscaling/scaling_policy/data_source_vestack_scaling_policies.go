...
func DataSourceVestackScalingPolicies() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackScalingPoliciesRead,
...
func dataSourceVestackScalingPoliciesRead(d *schema.ResourceData, meta interface{}) error {
	scalingPolicyService := NewScalingPolicyService(meta.(*ve.SdkClient))
	return scalingPolicyService.Dispatcher.Data(scalingPolicyService, d, DataSourceVestackScalingPolicies())
}
