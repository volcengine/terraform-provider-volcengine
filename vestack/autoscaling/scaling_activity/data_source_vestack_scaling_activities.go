...
func DataSourceVestackScalingActivities() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackScalingActivitiesRead,
...
func dataSourceVestackScalingActivitiesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewScalingActivityService(meta.(*ve.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceVestackScalingActivities())
}
