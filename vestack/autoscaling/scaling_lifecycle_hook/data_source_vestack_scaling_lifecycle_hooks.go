...
func DataSourceVestackScalingLifecycleHooks() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackScalingLifecycleHooksRead,
...
func dataSourceVestackScalingLifecycleHooksRead(d *schema.ResourceData, meta interface{}) error {
	lifecycleHookService := NewScalingLifecycleHookService(meta.(*ve.SdkClient))
	return lifecycleHookService.Dispatcher.Data(lifecycleHookService, d, DataSourceVestackScalingLifecycleHooks())
}
