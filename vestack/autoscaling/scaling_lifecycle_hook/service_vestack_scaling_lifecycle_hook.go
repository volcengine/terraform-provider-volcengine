...
type VestackScalingLifecycleHookService struct {
	Client     *ve.SdkClient
	Dispatcher *ve.Dispatcher
}

func NewScalingLifecycleHookService(c *ve.SdkClient) *VestackScalingLifecycleHookService {
	return &VestackScalingLifecycleHookService{
		Client:     c,
		Dispatcher: &ve.Dispatcher{},
	}
}

func (s *VestackScalingLifecycleHookService) GetClient() *ve.SdkClient {
	return s.Client
}

func (s *VestackScalingLifecycleHookService) ReadResources(m map[string]interface{}) (data []interface{}, err error) {
	var (
...
func (s *VestackScalingLifecycleHookService) ReadResource(resourceData *schema.ResourceData, id string) (data map[string]interface{}, err error) {
	var (
		results []interface{}
		ok      bool
	)
...
func (s *VestackScalingLifecycleHookService) RefreshResourceState(resourceData *schema.ResourceData, target []string, timeout time.Duration, id string) *resource.StateChangeConf {
	return &resource.StateChangeConf{}
}

func (VestackScalingLifecycleHookService) WithResourceResponseHandlers(scalingGroup map[string]interface{}) []ve.ResourceResponseHandler {
...
func (s *VestackScalingLifecycleHookService) CreateResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
...
func (s *VestackScalingLifecycleHookService) ModifyResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
...
func (s *VestackScalingLifecycleHookService) RemoveResource(resourceData *schema.ResourceData, r *schema.Resource) []ve.Callback {
	ids := strings.Split(resourceData.Id(), ":")
	callback := ve.Callback{
		Call: ve.SdkCall{
...
func (s *VestackScalingLifecycleHookService) DatasourceResources(*schema.ResourceData, *schema.Resource) ve.DataSourceInfo {
