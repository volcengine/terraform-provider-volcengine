...
type VestackScalinggroupServerGroupService struct {
	Client     *ve.SdkClient
	Dispatcher *ve.Dispatcher
}

func NewScalinggroupServerGroupService(c *ve.SdkClient) *VestackScalinggroupServerGroupService {
	return &VestackScalinggroupServerGroupService{
		Client:     c,
		Dispatcher: &ve.Dispatcher{},
	}
}

func (s *VestackScalinggroupServerGroupService) GetClient() *ve.SdkClient {
	return s.Client
}

func (s *VestackScalinggroupServerGroupService) ReadResources(m map[string]interface{}) (data []interface{}, err error) {
	var (
...
func (s *VestackScalinggroupServerGroupService) ReadResource(resourceData *schema.ResourceData, id string) (data map[string]interface{}, err error) {
	var (
		results []interface{}
		ok      bool
	)
...
func (s *VestackScalinggroupServerGroupService) RefreshResourceState(resourceData *schema.ResourceData, target []string, timeout time.Duration, id string) *resource.StateChangeConf {
...
func (s *VestackScalinggroupServerGroupService) ModifyResource(resourceData *schema.ResourceData, r *schema.Resource) []ve.Callback {
...
func (s *VestackScalinggroupServerGroupService) RemoveResource(resourceData *schema.ResourceData, r *schema.Resource) []ve.Callback {
	callback := ve.Callback{
		Call: ve.SdkCall{
			Action:      "DetachServerGroups",
			ConvertMode: ve.RequestConvertIgnore,
...
func (s *VestackScalinggroupServerGroupService) DatasourceResources(*schema.ResourceData, *schema.Resource) ve.DataSourceInfo {
