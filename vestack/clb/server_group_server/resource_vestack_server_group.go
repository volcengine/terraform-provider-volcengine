...
func resourceVestackServerGroupServerCreate(d *schema.ResourceData, meta interface{}) (err error) {
	...
	err = serverGroupServerService.Dispatcher.Create(serverGroupServerService, d, ResourceVestackServerGroupServer())
	if err != nil {
...
func resourceVestackServerGroupServerRead(d *schema.ResourceData, meta interface{}) (err error) {
	serverGroupServerService := NewServerGroupServerService(meta.(*ve.SdkClient))
	err = serverGroupServerService.Dispatcher.Read(serverGroupServerService, d, ResourceVestackServerGroupServer())
	if err != nil {
...
func resourceVestackServerGroupServerUpdate(d *schema.ResourceData, meta interface{}) (err error) {
	serverGroupServerService := NewServerGroupServerService(meta.(*ve.SdkClient))
	err = serverGroupServerService.Dispatcher.Update(serverGroupServerService, d, ResourceVestackServerGroupServer())
	if err != nil {
...
func resourceVestackServerGroupServerDelete(d *schema.ResourceData, meta interface{}) (err error) {
	serverGroupServerService := NewServerGroupServerService(meta.(*ve.SdkClient))
	err = serverGroupServerService.Dispatcher.Delete(serverGroupServerService, d, ResourceVestackServerGroupServer())
	if err != nil {
