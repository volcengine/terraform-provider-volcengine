...
func NewVolumeService(c *ve.SdkClient) *VestackVolumeService {
...
func (s *VestackVolumeService) GetClient() *ve.SdkClient {
	return s.Client
}
...
func (VestackVolumeService) WithResourceResponseHandlers(volume map[string]interface{}) []ve.ResourceResponseHandler {
...
func (s *VestackVolumeService) CreateResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
...
func (s *VestackVolumeService) ModifyResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
...
func (s *VestackVolumeService) RemoveResource(resourceData *schema.ResourceData, r *schema.Resource) []ve.Callback {
	callback := ve.Callback{
		Call: ve.SdkCall{
			Action:      "DeleteVolume",
			ConvertMode: ve.RequestConvertIgnore,
...
func (s *VestackVolumeService) DatasourceResources(*schema.ResourceData, *schema.Resource) ve.DataSourceInfo {
