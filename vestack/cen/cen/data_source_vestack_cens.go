...
func DataSourceVestackCens() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackCensRead,
...
func dataSourceVestackCensRead(d *schema.ResourceData, meta interface{}) error {
	cenService := NewCenService(meta.(*ve.SdkClient))
	return cenService.Dispatcher.Data(cenService, d, DataSourceVestackCens())
}
