...
func DataSourceVestackCenBandwidthPackages() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackCenBandwidthPackagesRead,
...
func dataSourceVestackCenBandwidthPackagesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewCenBandwidthPackageService(meta.(*ve.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceVestackCenBandwidthPackages())
}
