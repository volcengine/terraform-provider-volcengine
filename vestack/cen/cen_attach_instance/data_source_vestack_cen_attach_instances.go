...
func DataSourceVestackCenAttachInstances() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackCenInstanceAttachInstances,
...
func dataSourceVestackCenInstanceAttachInstances(d *schema.ResourceData, meta interface{}) error {
	cenAttachInstanceService := NewCenAttachInstanceService(meta.(*ve.SdkClient))
	return cenAttachInstanceService.Dispatcher.Data(cenAttachInstanceService, d, DataSourceVestackCenAttachInstances())
}
