...
func DataSourceVestackCenServiceRouteEntries() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackCenServiceRouteEntriesRead,
...
func dataSourceVestackCenServiceRouteEntriesRead(d *schema.ResourceData, meta interface{}) error {
	service := NewCenServiceRouteEntryService(meta.(*ve.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceVestackCenServiceRouteEntries())
}
