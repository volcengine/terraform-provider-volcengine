...
func DataSourceVestackCenInterRegionBandwidths() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackCenInterRegionBandwidthsRead,
...
func dataSourceVestackCenInterRegionBandwidthsRead(d *schema.ResourceData, meta interface{}) error {
	service := NewCenInterRegionBandwidthService(meta.(*ve.SdkClient))
	return service.Dispatcher.Data(service, d, DataSourceVestackCenInterRegionBandwidths())
}
