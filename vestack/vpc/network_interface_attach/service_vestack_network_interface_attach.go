...
func NewNetworkInterfaceAttachService(c *ve.SdkClient) *VestackNetworkInterfaceAttachService {
...
func (s *VestackNetworkInterfaceAttachService) GetClient() *ve.SdkClient {
	return s.Client
}
...
func (VestackNetworkInterfaceAttachService) WithResourceResponseHandlers(networkInterface map[string]interface{}) []ve.ResourceResponseHandler {
...
func (s *VestackNetworkInterfaceAttachService) CreateResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
...
func (s *VestackNetworkInterfaceAttachService) ModifyResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
	return []ve.Callback{}
}

func (s *VestackNetworkInterfaceAttachService) RemoveResource(resourceData *schema.ResourceData, r *schema.Resource) []ve.Callback {
...
func (s *VestackNetworkInterfaceAttachService) DatasourceResources(*schema.ResourceData, *schema.Resource) ve.DataSourceInfo {
