...
func NewRouteTableAssociateService(c *ve.SdkClient) *VestackRouteTableAssociateService {
...
func (s *VestackRouteTableAssociateService) GetClient() *ve.SdkClient {
	return s.Client
}
...
func (VestackRouteTableAssociateService) WithResourceResponseHandlers(routeTables map[string]interface{}) []ve.ResourceResponseHandler {
...
func (s *VestackRouteTableAssociateService) CreateResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
...
func (s *VestackRouteTableAssociateService) ModifyResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
	return nil
}

func (s *VestackRouteTableAssociateService) RemoveResource(resourceData *schema.ResourceData, r *schema.Resource) []ve.Callback {
...
func (s *VestackRouteTableAssociateService) DatasourceResources(*schema.ResourceData, *schema.Resource) ve.DataSourceInfo {
