...
func NewVpcService(c *ve.SdkClient) *VestackVpcService {
...
func (s *VestackVpcService) GetClient() *ve.SdkClient {
	return s.Client
}
...
func (VestackVpcService) WithResourceResponseHandlers(vpc map[string]interface{}) []ve.ResourceResponseHandler {
...
func (s *VestackVpcService) CreateResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
	callback := ve.Callback{
		Call: ve.SdkCall{
			...
			AfterCall: func(d *schema.ResourceData, client *ve.SdkClient, resp *map[string]interface{}, call ve.SdkCall) error {
				...
				id, _ := ve.ObtainSdkValue("Result.VpcId", *resp)
				d.SetId(id.(string))
				return nil
			},
...
func (s *VestackVpcService) ModifyResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
	callback := ve.Callback{
		Call: ve.SdkCall{
...
func (s *VestackVpcService) RemoveResource(resourceData *schema.ResourceData, r *schema.Resource) []ve.Callback {
	callback := ve.Callback{
		Call: ve.SdkCall{
			Action:      "DeleteVpc",
...
func (s *VestackVpcService) DatasourceResources(*schema.ResourceData, *schema.Resource) ve.DataSourceInfo {
