...
func NewEipAssociateService(c *ve.SdkClient) *VestackEipAssociateService {
...
func (s *VestackEipAssociateService) GetClient() *ve.SdkClient {
	return s.Client
}
...
func (VestackEipAssociateService) WithResourceResponseHandlers(eip map[string]interface{}) []ve.ResourceResponseHandler {
...
func (s *VestackEipAssociateService) CreateResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
...
func (s *VestackEipAssociateService) ModifyResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
	return nil
}

func (s *VestackEipAssociateService) RemoveResource(resourceData *schema.ResourceData, r *schema.Resource) []ve.Callback {
...
func (s *VestackEipAssociateService) DatasourceResources(*schema.ResourceData, *schema.Resource) ve.DataSourceInfo {
