...
type VestackAccessKeyService struct {
	Client     *ve.SdkClient
	Dispatcher *ve.Dispatcher
}

func NewAccessKeyService(c *ve.SdkClient) *VestackAccessKeyService {
	return &VestackAccessKeyService{
		Client:     c,
		Dispatcher: &ve.Dispatcher{},
	}
}

func (s *VestackAccessKeyService) GetClient() *ve.SdkClient {
	return s.Client
}

func (s *VestackAccessKeyService) ReadResources(m map[string]interface{}) (data []interface{}, err error) {
	var (
...
func (s *VestackAccessKeyService) ReadResource(resourceData *schema.ResourceData, id string) (data map[string]interface{}, err error) {
	var (
		results []interface{}
		ok      bool
	)
...
func (s *VestackAccessKeyService) RefreshResourceState(resourceData *schema.ResourceData, target []string, timeout time.Duration, id string) *resource.StateChangeConf {
...
func (VestackAccessKeyService) WithResourceResponseHandlers(v map[string]interface{}) []ve.ResourceResponseHandler {
...
func (s *VestackAccessKeyService) CreateResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
...
func (s *VestackAccessKeyService) ModifyResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
	callbacks := make([]ve.Callback, 0)
...
func (s *VestackAccessKeyService) RemoveResource(resourceData *schema.ResourceData, r *schema.Resource) []ve.Callback {
	callbacks := make([]ve.Callback, 0)
...
func (s *VestackAccessKeyService) DatasourceResources(*schema.ResourceData, *schema.Resource) ve.DataSourceInfo {
	return ve.DataSourceInfo{}
}

func (s *VestackAccessKeyService) ReadResourceId(id string) string {
	return id
}
...
func (s *VestackAccessKeyService) updateAccessKeyStatus(status string, resourceData *schema.ResourceData) ve.Callback {
	return ve.Callback{
		Call: ve.SdkCall{
