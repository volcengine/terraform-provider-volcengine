...
func NewIamUserService(c *ve.SdkClient) *VestackIamUserService {
...
func (s *VestackIamUserService) GetClient() *ve.SdkClient {
	return s.Client
}
...
func (VestackIamUserService) WithResourceResponseHandlers(v map[string]interface{}) []ve.ResourceResponseHandler {
...
func (s *VestackIamUserService) CreateResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
...
func (s *VestackIamUserService) ModifyResource(resourceData *schema.ResourceData, resource *schema.Resource) []ve.Callback {
	callback := ve.Callback{
		Call: ve.SdkCall{
			Action:      "UpdateUser",
...
func (s *VestackIamUserService) RemoveResource(resourceData *schema.ResourceData, r *schema.Resource) []ve.Callback {
	callback := ve.Callback{
		Call: ve.SdkCall{
			Action:         "DeleteUser",
...
func (s *VestackIamUserService) DatasourceResources(*schema.ResourceData, *schema.Resource) ve.DataSourceInfo {
