...
func DataSourceVestackVpnGatewayRoutes() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackVpnGatewayRoutesRead,
...
func dataSourceVestackVpnGatewayRoutesRead(d *schema.ResourceData, meta interface{}) error {
	routeService := NewVpnGatewayRouteService(meta.(*ve.SdkClient))
	return routeService.Dispatcher.Data(routeService, d, DataSourceVestackVpnGatewayRoutes())
}
