...
func DataSourceVestackVpnGateways() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackVpnGatewaysRead,
...
func dataSourceVestackVpnGatewaysRead(d *schema.ResourceData, meta interface{}) error {
	vpnGatewayService := NewVpnGatewayService(meta.(*ve.SdkClient))
	return vpnGatewayService.Dispatcher.Data(vpnGatewayService, d, DataSourceVestackVpnGateways())
}
