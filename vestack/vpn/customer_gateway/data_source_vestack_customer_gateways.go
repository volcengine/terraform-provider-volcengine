...
func DataSourceVestackCustomerGateways() *schema.Resource {
	return &schema.Resource{
		Read: dataSourceVestackCustomerGatewaysRead,
...
func dataSourceVestackCustomerGatewaysRead(d *schema.ResourceData, meta interface{}) error {
	customerGatewayService := NewCustomerGatewayService(meta.(*ve.SdkClient))
	return customerGatewayService.Dispatcher.Data(customerGatewayService, d, DataSourceVestackCustomerGateways())
}
